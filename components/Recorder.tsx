      ...
      !startCamera
        ...
        <div className="p-10 grid grid-cols-1 gifosShadowWhite">
          <div className='flex justify-center py-10'>
            ...
            <h1 className='font-bold text-black dark:text-[#110538] text-lg lg:text-3xl font-chakra'>Here you will be able to create your own gifs</h1>
          </div>
          <p className='leading-10 font-chakra dark:text-[#110538] hidden md:block lg:block none'>
